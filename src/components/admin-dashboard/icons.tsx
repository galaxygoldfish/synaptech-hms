...
// Same stroke weight and circle as InfoIcon, so the two read as one family.
...
// Download-as-separate-files: two corner-bracketed frames around a code
// square, distinct from DownloadIconFilled's single-arrow glyph.
export function DownloadSeparateIconFilled({ size = 20, color = "#616161", className }: IconProps & { color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5.5 1H1V5.5H2V2H5.5V1ZM11 12H5C4.73488 11.9997 4.4807 11.8942 4.29323 11.7068C4.10576 11.5193 4.0003 11.2651 4 11V5C4.0003 4.73488 4.10576 4.4807 4.29323 4.29323C4.4807 4.10576 4.73488 4.0003 5 4H11C11.2651 4.0003 11.5193 4.10576 11.7068 4.29323C11.8942 4.4807 11.9997 4.73488 12 5V11C11.9997 11.2651 11.8942 11.5193 11.7068 11.7068C11.5193 11.8942 11.2651 11.9997 11 12ZM5 5V11H11V5H5ZM1 15V10.5H2V14H5.5V15H1ZM15 5.5V1H10.5V2H14V5.5H15ZM15 15H10.5V14H14V10.5H15V15Z"
        fill={color}
      />
    </svg>
  );
...
// Used in the red "couldn't access the camera" state inside a scan
// viewfinder — the same shade as .inlineError across the scan screens, so
// the icon and its message read as one color.
export function CameraIconFilled({ size = 16, color = "#b9433c", className }: IconProps & { color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M1.5 13H14.5C14.6326 13 14.7598 12.9473 14.8536 12.8536C14.9473 12.7598 15 12.6326 15 12.5V4C15 3.86739 14.9473 3.74021 14.8536 3.64645C14.7598 3.55268 14.6326 3.5 14.5 3.5H11.27L10.415 2.225C10.3697 2.15622 10.3081 2.09969 10.2357 2.06044C10.1633 2.02119 10.0824 2.00043 10 2H6C5.91765 2.00043 5.83667 2.02119 5.76427 2.06044C5.69188 2.09969 5.63029 2.15622 5.585 2.225L4.73 3.5H1.5C1.36739 3.5 1.24021 3.55268 1.14645 3.64645C1.05268 3.74021 1 3.86739 1 4V12.5C1 12.6326 1.05268 12.7598 1.14645 12.8536C1.24021 12.9473 1.36739 13 1.5 13ZM14 12H2V4.5H5C5.08235 4.49957 5.16333 4.47881 5.23573 4.43956C5.30812 4.40031 5.36971 4.34378 5.415 4.275L6.27 3H9.73L10.585 4.275C10.6303 4.34378 10.6919 4.40031 10.7643 4.43956C10.8367 4.47881 10.9176 4.49957 11 4.5H14V12ZM6.33329 10.4944C6.82664 10.8241 7.40666 11 8 11C8.79565 11 9.55871 10.6839 10.1213 10.1213C10.6839 9.55871 11 8.79565 11 8C11 7.40666 10.8241 6.82664 10.4944 6.33329C10.1648 5.83994 9.69623 5.45543 9.14805 5.22836C8.59987 5.0013 7.99667 4.94189 7.41473 5.05765C6.83279 5.1734 6.29824 5.45912 5.87868 5.87868C5.45912 6.29824 5.1734 6.83279 5.05765 7.41473C4.94189 7.99667 5.0013 8.59987 5.22836 9.14805C5.45543 9.69623 5.83994 10.1648 6.33329 10.4944ZM6.88886 6.33706C7.21776 6.1173 7.60444 6 8 6C8.53043 6 9.03914 6.21071 9.41421 6.58579C9.78929 6.96086 10 7.46957 10 8C10 8.39556 9.8827 8.78224 9.66294 9.11114C9.44318 9.44004 9.13082 9.69638 8.76537 9.84776C8.39992 9.99914 7.99778 10.0387 7.60982 9.96157C7.22186 9.8844 6.86549 9.69392 6.58579 9.41421C6.30608 9.13451 6.1156 8.77814 6.03843 8.39018C5.96126 8.00222 6.00087 7.60009 6.15224 7.23463C6.30362 6.86918 6.55996 6.55682 6.88886 6.33706Z"
        fill={color}
      />
    </svg>
  );
