...
interface CheckoutFlowHeaderProps {
  userName: string
  onBack: () => void
}

export function CheckoutFlowHeader({ userName, onBack }: CheckoutFlowHeaderProps) {
  return (
    <>
      ...
      <button type="button" className="pill-button checkout-flow__back" onClick={onBack}>
